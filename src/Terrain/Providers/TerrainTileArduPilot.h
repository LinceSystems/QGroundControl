...
public:
    ...
    static QList<QGeoCoordinate> parseCoordinateData(const QString &name, const QByteArray &coordinateData);
    static QByteArray serializeFromData(const QString &name, const QByteArray &input);
